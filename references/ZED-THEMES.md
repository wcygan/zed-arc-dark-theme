...
Create a Zed Theme for Arc Dark using two references:

1. The IntelliJ Arc Dark Theme (file locations: references/arc-theme-idea-master)
2. A reference Zed Theme, Zedokai (file locations: references/zedokai-main)

We will use the references from Zed on creating themes, as well as these real examples, to create the Arc Dark theme in Zed

## References

1. https://zed.dev/docs/themes
2. https://zed.dev/docs/extensions/themes
3. https://zed.dev/blog/user-themes-now-in-preview
4. https://zed.dev/schema/themes/v0.2.0.json

## Theme Schema as of November 14th, 2025
